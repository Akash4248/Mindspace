        ...
        {mobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white/95 backdrop-blur-md">
            <div className="px-2 pt-2 pb-3 space-y-1">
              <a
                href="#features"
                className="block px-3 py-2 text-white hover:text-yellow-300"
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            <div className="mb-12 lg:mb-0">
              ...
              <h1 className="text-4xl lg:text-6xl font-bold text-white leading-tight mb-6">
                Transform Your
                <span className="text-yellow-300 block">Mind & Space</span>
                with AI-Powered AR
              </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="p-8 glass border-0">
              <div className="text-center">
                ...
                <p className="text-gray-200 mb-6">Forever</p>
            ...
            <Card className="p-8 glass border-2 border-mindspace-300 relative">
              ...
              <div className="text-center">
                ...
                <p className="text-4xl font-bold text-white mb-1">$9.99</p>
                <p className="text-gray-200 mb-6">per month</p>
                <ul className="space-y-4 mb-8 text-left">
                  <li className="flex items-center">
                    <Check className="h-5 w-5 text-emerald-500 mr-3" />
            ...
            <Card className="p-8 glass border-0">
              <div className="text-center">
                ...
                <p className="text-gray-200 mb-6">Contact us</p>
                <ul className="space-y-4 mb-8 text-left">
                  <li className="flex items-center">
                    <Check className="h-5 w-5 text-emerald-500 mr-3" />
